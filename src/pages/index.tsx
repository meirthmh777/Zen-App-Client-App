      ...
      <div className="px-8 md:px-32">
        <div className="relative flex flex-col md:flex-row py-6 items-center">
          <div className="w-full md:w-1/2 p-4 md:p-0 relative z-10">
            <div className="text-4xl md:text-6xl text-[#055254] font-bold">
              Zen Zone
            </div>
            <div className="text-lg md:text-3xl text-[#055254] font-medium mt-4">
              ZenZone provides a welcoming environment to discuss mental health
              challenges openly, offering professional guidance and community
              support to help you feel understood and empowered.
            </div>
        ...
        <div className="flex justify-center items-center flex-col py-6">
          ...
          <div className="text-lg md:text-3xl">
            Kami akan memberikan solusi dari segala penyakit mental yang anda
            alami
          </div>
        </div>
          ...
          <div className="flex flex-col w-full md:w-1/2">
            <div className="flex gap-4 pl-4 pt-4 md:pt-0 ">
              ...
              <div>
                ...
                <div className="text-lg text-justify md:text-2xl">
                  Kami menyediakan sebuah fitur Forums dimana anda bisa bertanya
                  dan mengetahui pengalaman/saran dari orang-orang lain yang
                  memiliki penyakit mental, anda bisa menggunakan fitur ini
                  untuk saling berinteraksi dengan para pengguna lainnya.
                </div>
              </div>
            </div>
            <div className="flex gap-4 pl-4 pt-4">
              ...
              <div>
                ...
                <div className=" text-lg text-justify md:text-2xl">
                  Kami menyediakan sebuah fitur Consouelling dimana anda bisa
                  berkonsultasi dan mendapatkan saran dari para profesional
            ...
            <div className="flex gap-4 pl-4 pt-4">
              ...
              <div>
                ...
                <div className="text-lg text-justify md:text-2xl">
                  Kami menyediakan sebuah fitur Diary dimana anda bisa
                  menuliskan pengalaman pribadi anda terkait kesehatan mental.
                </div>
              </div>
            </div>
            <div className="flex gap-4 pl-4 pt-4">
              ...
              <div>
                ...
                <div className="text-lg text-justify md:text-2xl">
                  Kami menyediakan berbagai artikel tentang kesehatan mental
                  yang dapat membantu anda memahami dan mengatasi masalah
                  kesehatan mental.
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col md:flex-row gap-6 pb-4">
          <div className="w-full md:w-1/2 order-2 md:order-1">
            ...
            <div className="text-lg text-justify mt-4 md:mt-0 md:text-2xl">
              Kami menyediakan sebuah fitur Forums dimana anda bisa bertanya dan
              mengetahui pengalaman/saran dari orang-orang lain yang memiliki
              penyakit mental, anda bisa menggunakan fitur ini untuk saling
          ...
          <div className="flex flex-col-reverse md:flex-row py-6">
            ...
            <div className="flex flex-col justify-center w-full md:w-1/2 order-1 md:order-2 mt-4 md:mt-0">
              <div className="text-lg text-justify">
                feedback yang kamu berikan sangat berarti bagi kami untuk
                menganalisa kekurangan maupun kelebihan sehingga kami bisa
                semakin berkembang dari feedback yang telah anda kirimkan
              </div>
